...
pub struct Connection {
	...
	pub(crate) cache: tivet_cache::Cache,
}
...
impl Connection {
	...
	pub async fn nats(&self) -> Result<NatsPool, tivet_pools::Error> {
		self.pools.nats()
	}
	...
	pub async fn redis_chirp(&self) -> Result<RedisPool, tivet_pools::Error> {
	...
	pub async fn redis_chirp_ephemeral(&self) -> Result<RedisPool, tivet_pools::Error> {
