				...
				match key.to_unescaped()?.as_ref() {
					...
					"banned_identities" => {
						builder = builder.set_banned_identities(
							crate::json_deser::deser_list_tivet_group_group_banned_identities(
								tokens,
							)?,
						);
					}
				...
				match key.to_unescaped()?.as_ref() {
					...
					"join_requests" => {
						builder = builder.set_join_requests(
							crate::json_deser::deser_list_tivet_group_group_join_requests(tokens)?,
						);
					}
					"watch" => {
						builder = builder.set_watch(
				...
				match key.to_unescaped()?.as_ref() {
					...
					"members" => {
						builder = builder.set_members(
							crate::json_deser::deser_list_tivet_group_group_members(tokens)?,
						);
					}
					"watch" => {
						builder = builder.set_watch(
		...
		match tokens.next().transpose()? {
			...
			Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
				match key.to_unescaped()?.as_ref() {
					...
					"groups" => {
						builder = builder.set_groups(
							crate::json_deser::deser_list_tivet_group_group_handles(tokens)?,
						);
					}
					_ => aws_smithy_json::deserialize::token::skip_value(tokens)?,
				}
...
pub fn deser_list_tivet_group_group_banned_identities<'a, I>(
...
#[allow(clippy::type_complexity, non_snake_case)]
pub fn deser_list_tivet_group_group_join_requests<'a, I>(
	tokens: &mut std::iter::Peekable<I>,
) -> Result<
...
#[allow(clippy::type_complexity, non_snake_case)]
pub fn deser_list_tivet_group_group_members<'a, I>(
	tokens: &mut std::iter::Peekable<I>,
				...
				match tokens.next().transpose()? {
					...
					Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
						match key.to_unescaped()?.as_ref() {
							...
							"members" => {
								builder = builder.set_members(
									crate::json_deser::deser_list_tivet_group_group_members(
										tokens,
									)?,
								);
							}
							"join_requests" => {
								builder = builder.set_join_requests(
									crate::json_deser::deser_list_tivet_group_group_join_requests(
										tokens,
									)?,
								);
							}
...
#[allow(clippy::type_complexity, non_snake_case)]
pub fn deser_list_tivet_group_group_handles<'a, I>(
	tokens: &mut std::iter::Peekable<I>,
