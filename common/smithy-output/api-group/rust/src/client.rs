...
///
/// ```
/// use tivet_group::{Builder, Client, Config};
/// let raw_client =
///     Builder::dyn_https()
/// #     /*
	...
	R: aws_smithy_client::retry::NewRequestPolicy,
{
	...
	///
	/// - The fluent builder is configurable:
	///   - [`group_invite_code(impl Into<String>)`](crate::client::fluent_builders::ConsumeGroupInvite::group_invite_code) / [`set_group_invite_code(Option<String>)`](crate::client::fluent_builders::ConsumeGroupInvite::set_group_invite_code): Provided by `tivet.api.group#CreateGroupInviteOutput$code`.
	...
	///   - [`code(Option<String>)`](crate::output::CreateGroupInviteOutput::code): The code that will be passed to `tivet.api.group#ConsumeGroupInvite` to join a group.
	...
	///
	/// - The fluent builder is configurable:
	///   - [`group_invite_code(impl Into<String>)`](crate::client::fluent_builders::GetGroupInvite::group_invite_code) / [`set_group_invite_code(Option<String>)`](crate::client::fluent_builders::GetGroupInvite::set_group_invite_code): Provided by `tivet.api.group#CreateGroupInviteOutput$code`.
...
pub mod fluent_builders {
	...
	///
	/// Completes an avatar image upload. Must be called after the file upload process completes. Call `tivet.api.group#PrepareGroupAvatarUpload` first.
	#[derive(std::clone::Clone, std::fmt::Debug)]
		...
		R: aws_smithy_client::retry::NewRequestPolicy,
	{
		...
		/// Provided by `tivet.api.group#CreateGroupInviteOutput$code`.
	...
	///
	/// Prepares an avatar image upload. Complete upload with `tivet.api.group#CompleteGroupAvatarUpload`.
	#[derive(std::clone::Clone, std::fmt::Debug)]
