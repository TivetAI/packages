						...
						match key.to_unescaped()?.as_ref() {
							...
							"platforms" => {
								builder = builder.set_platforms(
									crate::json_deser::deser_list_tivet_game_game_platforms(
										tokens,
									)?,
								);
							}
							"recommended_groups" => {
								builder = builder.set_recommended_groups(
									crate::json_deser::deser_list_tivet_group_group_summaries(
										tokens,
									)?,
								);
							}
							"identity_leaderboard_categories" => {
								builder = builder.set_identity_leaderboard_categories(
                                    crate::json_deser::deser_list_tivet_game_game_leaderboard_categories(tokens)?
                                );
							}
...
#[allow(clippy::type_complexity, non_snake_case)]
pub fn deser_list_tivet_game_game_platforms<'a, I>(
	tokens: &mut std::iter::Peekable<I>,
) -> Result<
...
#[allow(clippy::type_complexity, non_snake_case)]
pub fn deser_list_tivet_game_game_leaderboard_categories<'a, I>(
	tokens: &mut std::iter::Peekable<I>,
) -> Result<
