				...
				match key.to_unescaped()?.as_ref() {
					"invites" => {
						builder = builder.set_invites(
							crate::json_deser::deser_list_tivet_api_party_common_created_invites(
								tokens,
							)?,
						);
					}
...
pub fn deser_list_tivet_api_party_common_created_invites<'a, I>(
				...
				match tokens.next().transpose()? {
					...
					Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
						match key.to_unescaped()?.as_ref() {
							...
							"invites" => {
								builder = builder.set_invites(
									crate::json_deser::deser_list_tivet_party_party_invites(
										tokens,
									)?,
								);
							}
...
#[allow(clippy::type_complexity, non_snake_case)]
pub fn deser_list_tivet_party_party_invites<'a, I>(
	tokens: &mut std::iter::Peekable<I>,
