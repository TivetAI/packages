...
///
/// ```
/// use tivet_party::{Builder, Client, Config};
/// let raw_client =
///     Builder::dyn_https()
/// #     /*
	...
	R: aws_smithy_client::retry::NewRequestPolicy,
{
	...
	///
	/// - The fluent builder is configurable:
	///   - [`token(impl Into<String>)`](crate::client::fluent_builders::GetPartyFromInvite::token) / [`set_token(Option<String>)`](crate::client::fluent_builders::GetPartyFromInvite::set_token): See `tivet.api.party#CreatedInvite$token`.
	///   - [`alias(impl Into<String>)`](crate::client::fluent_builders::GetPartyFromInvite::alias) / [`set_alias(Option<String>)`](crate::client::fluent_builders::GetPartyFromInvite::set_alias): An alias used to join a given party. This alias must be unique for all invites for your game. Pass this alias to `tivet.api.party.common#CreatedInvite$alias` to consume the invite.
	...
	///   - [`matchmaker_current_player_token(impl Into<String>)`](crate::client::fluent_builders::JoinParty::matchmaker_current_player_token) / [`set_matchmaker_current_player_token(Option<String>)`](crate::client::fluent_builders::JoinParty::set_matchmaker_current_player_token): If the player is currently in the lobby, pass the token from `tivet.matchmaker#MatchmakerLobbyJoinInfoPlayer$token`. This will prevent issuing a new player token.
	...
	///
	/// - The fluent builder is configurable:
	///   - [`public(PartyPublicityLevel)`](crate::client::fluent_builders::SetPartyPublicity::public) / [`set_public(Option<PartyPublicityLevel>)`](crate::client::fluent_builders::SetPartyPublicity::set_public): Defaults to `tivet.party#PartyPublicityLevel$VIEW`.
	///   - [`mutual_followers(PartyPublicityLevel)`](crate::client::fluent_builders::SetPartyPublicity::mutual_followers) / [`set_mutual_followers(Option<PartyPublicityLevel>)`](crate::client::fluent_builders::SetPartyPublicity::set_mutual_followers): Defaults to `tivet.party#PartyPublicityLevel$JOIN`.
	///   - [`groups(PartyPublicityLevel)`](crate::client::fluent_builders::SetPartyPublicity::groups) / [`set_groups(Option<PartyPublicityLevel>)`](crate::client::fluent_builders::SetPartyPublicity::set_groups): Defaults to `tivet.party#PartyPublicityLevel$VIEW`.
...
pub mod fluent_builders {
		...
		R: aws_smithy_client::retry::NewRequestPolicy,
	{
		...
		/// See `tivet.api.party#CreatedInvite$token`.
