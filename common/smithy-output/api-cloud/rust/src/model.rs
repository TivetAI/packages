...
pub struct RegionTier {
	...
	pub tivet_cores_numerator: std::option::Option<i32>,
	/// Together with the numerator, denotes the portion of the CPU a given server uses.
	pub tivet_cores_denominator: std::option::Option<i32>,
	/// CPU frequency (MHz).
...
impl RegionTier {
	...
	/// Together with the denominator, denotes the portion of the CPU a given server uses.
	pub fn tivet_cores_numerator(&self) -> std::option::Option<i32> {
		self.tivet_cores_numerator
	}
	/// Together with the numerator, denotes the portion of the CPU a given server uses.
	pub fn tivet_cores_denominator(&self) -> std::option::Option<i32> {
		self.tivet_cores_denominator
	}
	/// CPU frequency (MHz).
...
impl std::fmt::Debug for RegionTier {
	fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		...
		formatter.field("tivet_cores_numerator", &self.tivet_cores_numerator);
		formatter.field("tivet_cores_denominator", &self.tivet_cores_denominator);
...
pub mod region_tier {
	...
	pub struct Builder {
		...
		pub(crate) tivet_cores_numerator: std::option::Option<i32>,
		pub(crate) tivet_cores_denominator: std::option::Option<i32>,
	...
	impl Builder {
		...
		/// Together with the denominator, denotes the portion of the CPU a given server uses.
		pub fn tivet_cores_numerator(mut self, input: i32) -> Self {
			self.tivet_cores_numerator = Some(input);
			self
		}
		/// Together with the denominator, denotes the portion of the CPU a given server uses.
		pub fn set_tivet_cores_numerator(mut self, input: std::option::Option<i32>) -> Self {
			self.tivet_cores_numerator = input;
			self
		}
		/// Together with the numerator, denotes the portion of the CPU a given server uses.
		pub fn tivet_cores_denominator(mut self, input: i32) -> Self {
			self.tivet_cores_denominator = Some(input);
			self
		}
		/// Together with the numerator, denotes the portion of the CPU a given server uses.
		pub fn set_tivet_cores_denominator(mut self, input: std::option::Option<i32>) -> Self {
			self.tivet_cores_denominator = input;
			self
		}
		/// CPU frequency (MHz).
		...
		pub fn build(self) -> crate::model::RegionTier {
			crate::model::RegionTier {
				...
				tivet_cores_numerator: self.tivet_cores_numerator,
				tivet_cores_denominator: self.tivet_cores_denominator,
				cpu: self.cpu,
				memory: self.memory,
				disk: self.disk,
