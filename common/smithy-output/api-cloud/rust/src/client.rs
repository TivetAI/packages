...
///
/// ```
/// use tivet_cloud::{Builder, Client, Config};
/// let raw_client =
///     Builder::dyn_https()
/// #     /*
	...
	R: aws_smithy_client::retry::NewRequestPolicy,
{
	...
	///   - [`name_id(impl Into<String>)`](crate::client::fluent_builders::CreateGameNamespace::name_id) / [`set_name_id(Option<String>)`](crate::client::fluent_builders::CreateGameNamespace::set_name_id): A human readable short identifier used to references resources. Different than a `tivet.common#Uuid` because this is intended to be human readable. Different than `tivet.common#DisplayName` because this should not include special characters and be short.
	...
	///   - [`name_id(impl Into<String>)`](crate::client::fluent_builders::ValidateGame::name_id) / [`set_name_id(Option<String>)`](crate::client::fluent_builders::ValidateGame::set_name_id): A human readable short identifier used to references resources. Different than a `tivet.common#Uuid` because this is intended to be human readable. Different than `tivet.common#DisplayName` because this should not include special characters and be short.
	...
	///   - [`name_id(impl Into<String>)`](crate::client::fluent_builders::ValidateGameNamespace::name_id) / [`set_name_id(Option<String>)`](crate::client::fluent_builders::ValidateGameNamespace::set_name_id): A human readable short identifier used to references resources. Different than a `tivet.common#Uuid` because this is intended to be human readable. Different than `tivet.common#DisplayName` because this should not include special characters and be short.
