...
// 	http_client: tivet_auth::ClientWrapper,
// 	user_id: Uuid,
// }
...
// 		let http_client = tivet_auth::Config::builder()
...
// 			.to_owned();
// 		let refresh_claims = tivet_claims::decode(&refresh_cookie).unwrap().unwrap();
// 		assert_eq!(
...
// 		let claims = tivet_claims::decode(res.token().unwrap()).unwrap().unwrap();
// 		assert_eq!(
