...
/// Modifies the provided job spec to be compatible with the Tivet job runtime.
fn modify_job_spec(
	config: &tivet_config::Config,
...
fn gen_cleanup_task(config: &tivet_config::Config) -> GlobalResult<nomad_client_new::models::Task> {
