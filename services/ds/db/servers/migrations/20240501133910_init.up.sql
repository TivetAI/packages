CREATE TABLE servers (
	...
	finish_ts INT,
	cleanup_ts INT,
	-- When the server was marked to be deleted by Tivet
	destroy_ts INT,

	-- Docker
	image_id UUID NOT NULL,
	args STRING[],
	network_mode INT NOT NULL, -- tivet.backend.ds.DockerNetworkMode
...
CREATE TABLE docker_ports_protocol_game_guard (  
    ...
    protocol INT NOT NULL, -- tivet.backend.ds.GameGuardProtocol
...
CREATE TABLE docker_ports_host (  
	...
	port_name STRING NOT NULL,
	port_number INT NOT NULL,
    protocol INT NOT NULL, -- tivet.backend.ds.HostProtocol
